...
import nftImg from '@public/images/fundraising_nft.webp'
...
export const FundraiseRewarding = () => {
  ...
  return (
    ...
    >
      <div tw="relative w-full h-full p-14 text-left flex flex-col lg:flex-row">
        <div>
        ...
        <div tw="mt-20 lg:mt-0 flex justify-center animate-pulse">
          <Image src={nftImg} alt="NFT rewards" />
        </div>
      </div>
    </SquareFrame>
  )
